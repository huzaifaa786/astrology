                ...
                <div class="col-sm-12">
                    <div class="blog-details news-slid">
                        <div class="news-text">
                            ...
                            <p>
                                User can only access app after login.
                            </p>
                            <p>
                                Astrotalk app is a subscription based app. you always need an active subscription to use
                                this
                                app.
                            </p>
                            <p>
                            ...
                            <p>
                                The terms used in this Privacy Policy have the same meanings as in our <a
                                    [routerLink]="'/terms-condition'">Terms and Conditions</a>, which is accessible at
                                Astrotalk
                        ...
                        <div class="news-text">
                            ...
                            <p>
                                ...
                                Phone, Addresses, Gender, Birthdate, Anniversary Date, Location, Profile Picture.
                                The information that we request will be retained by us and used as described in this privacy
                                policy.
                            </p>
                            <div>
                                <p>
                                    The app does use api to communicate with the server/data.
                                </p>
                                <p>
                                    <strong>Permissions Needed</strong>
                                </p>
                                <p>
                                    Astrotalk needs following permissions to run it.
                                </p>
                                <ul>
                                    ...
                                    <li>Device Permissions - (INTERNET, ACCESS_NETWORK_STATE, RECEIVE_BOOT_COMPLETED,
                                        VIBRATE)</li>
                                </ul>
                                <p>
                        ...
                        <div class="news-text">
                            ...
                            <p>
                                ...
                                collect data and
                                information (through third party products) on your phone called Log Data. This Log Data may
                                include information such
                                as your device Internet
                        ...
                        <div class="news-text">
                            ...
                            <p>
                                ...
                                code and libraries that
                                use “cookies” to collect information and improve their services. You have the option to
                        ...
                        <div class="news-text">
                            ...
                            <p>
                                ...
                                be directed to that
                                site. Note that these external sites are not operated by us. Therefore, we strongly advise
                                you to review the Privacy
                        ...
                        <div class="news-text">
                            ...
                            <p>
                                ...
                                information from children under 13. In the case we discover that a child under 13 has
                                provided us with personal
                                information, we immediately delete
                        ...
                        <div class="news-text">
                            ...
                            <p>This privacy policy page was created at <a href="https://privacypolicytemplate.net"
                                ...
                                modified/generated by <a href="https://app-privacy-policy-generator.nisrulz.com/"
                                    target="_blank" rel="noopener noreferrer">App
